	...
	<body>
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<p>Operation Bill : {!!$operation_bill!!} Tk.</p><br>
						<p>Dr. Bill : {!!$dr_bill!!} Tk.</p><br>
						<p>Service Bill : {!!$service_bill!!} Tk.</p><br>
						<p>Medicine Bill : {!!$medicine_bill!!} Tk.</p><br>
						<p>Cabin Bill : {!!$cabin_bill!!} Tk.</p><br>
						<p>Other's Bill : {!!$others_bill!!} Tk.</p><br>
